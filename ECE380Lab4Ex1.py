...
# Title: Ece 380 Lab 4 Ex1
# Author: Nolan Cameron and Aidan Slator
...
class ECE380Lab4Ex1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ece 380 Lab 4 Ex1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ece 380 Lab 4 Ex1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ECE380Lab4Ex1")
        ...
        self.f_dev_max = f_dev_max = 1000
        self.beta = beta = 0.2

        ##################################################
        # Blocks
        ##################################################
        self._beta_range = Range(0, 20, 0.1, 0.2, 200)
        self._beta_win = RangeWidget(self._beta_range, self.set_beta, "'beta'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._beta_win, 1, 2, 1, 1)
        for r in range(1, 2):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 0, 2, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, f_dev_max/beta, 1, 0, 0)
...
def main(top_block_cls=ECE380Lab4Ex1, options=None):
